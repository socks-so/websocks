...
// ../server/src/init.ts
var createReceiverFactory = (middlewares = []) => ({
  ...
  use: (middleware) => createReceiverFactory([...middlewares, middleware])
});
var createSenderFactory = (adapter) => ({
  messages: (messages) => {
...
function createMessageMap(messages, messageMap = /* @__PURE__ */ new Map(), prefix = "") {
...
function init(config) {
  return {
    ...
    sender: createSenderFactory(config.adapter),
    create: (opts) => {
...
// ../server/src/adapters/socks/index.ts
